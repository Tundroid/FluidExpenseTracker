...
public class CategorySwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public CategorySwipeToDeleteCallback(CategoryAdapter adapter, Context context) {
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        Category deletedItem = adapter.getList().get(position); // Store the deleted item
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton("Delete", (dialog, which) -> {
                    ...
                    Snackbar snackbar = Snackbar
                            .make(viewHolder.itemView, "Category deleted", Snackbar.LENGTH_LONG);
    ...
    private void sendDeleteRequest(Category deletedItem) {
        String baseUrl = context.getString(R.string.base_url);
        String url = baseUrl + "/delete/category"; // DELETE URL (no longer includes ID directly)
